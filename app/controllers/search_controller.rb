...
class SearchController < ApplicationController
  ...
  def home
    if params[:address]
      ...
      # GOES THROUGH EACH RESULT, FORMATS AS CLICKABLE LINK, FINDS PAGE HEADINGS
